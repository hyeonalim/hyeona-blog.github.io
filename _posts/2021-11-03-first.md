...
![windowstore](/img/post_fist/windowstore.png)
...
## 3. 세팅
![code-vs](/img/post_fist/code.png)
...
![gitcloneerror](/img/post_fist/gitcloneerror.png)

위처럼 git clone 시 에러가 뜨면 아래와 같은 방법으로 해결해준다.

![ssh](/img/post_fist/ssh.png)
